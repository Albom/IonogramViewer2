...
class IonogramRinan(Ionogram):
    ...
    def load(self, file_name):
        ...
        index_end_of_data = (
            lines[index_end_of_header + 1 :].index("END") + index_end_of_header + 1
        )
